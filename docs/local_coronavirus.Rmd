...
plotLocalCases(area = 'Cornwall and Isles of Scilly', dat = dat)

```

```{r, echo=FALSE, fig.width=12, fig.height = 4 }

plotLocalCases(area = 'Somerset', dat = dat)

```

```{r, echo=FALSE, fig.width=12, fig.height = 4 }

plotLocalCases(area = 'Plymouth', dat = dat)

```

```{r, echo=FALSE, fig.width=12, fig.height = 4 }

plotLocalCases(area = 'Torbay', dat = dat)

```
```{r, echo=FALSE, fig.width=12, fig.height = 4 }

plotLocalCases(area = 'Bournemouth, Christchurch and Poole', dat = dat)
