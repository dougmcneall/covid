...
plotlist_opoi = list('Milton Keynes','Reading', 'Leicester', 'Oldham' )

out = lapply(plotlist_opoi, FUN = plotLocalCasesWeeklyOverlay, dat = dat)
...
out = lapply(plotlist_eaer, FUN = plotLocalCasesWeeklyOverlay, dat = dat)
